...
import net.su.common.entity.garnet.RenderGarnet;
import net.su.common.entity.models.Amythist;
import net.su.common.entity.models.Garnet;
...
public class CommonProxy extends ClientProxy{
	...
	public void registerRenderThings() {
		 ...
		 RenderingRegistry.registerEntityRenderingHandler(EntityGarnetMob.class, new RenderGarnet(new Garnet(), 0));
	}
