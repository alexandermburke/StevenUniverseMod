...
public class itemGarnetGem extends ItemArmor
{
	public itemGarnetGem(int armourType)
	{
    ...
    {
        return Reference.MODID + ":textures/items/gems1.png";
    }
