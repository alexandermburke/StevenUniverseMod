...
public class itemStevenGem extends ItemArmor
{
	public itemStevenGem(int armourType)
	{
		super(ArmorMaterial.CHAIN, 4, armourType); //TODO custom material
	}
    ...
    {
        return Reference.MODID + ":textures/items/gems3.png";
    }
