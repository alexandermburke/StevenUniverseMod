...
public class itemPearlGem extends ItemArmor
{
	public itemPearlGem(int armourType)
	{
		super(ArmorMaterial.GOLD, 4, armourType); //TODO custom material
	}
    ...
    {
        return Reference.MODID + ":textures/items/gems2.png";
    }
