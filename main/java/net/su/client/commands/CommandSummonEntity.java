package net.su.client.commands;
...
public class CommandSummonEntity extends CommandBase
{
    ...
    {
        return "commands.summonentity.usage";
    }
    ...
    public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_)
    {
        ...
        {
            throw new WrongUsageException("commands.summonentity.usage", new Object[0]);
        }
        else
        {
            ...
            {
                func_152373_a(p_71515_1_, this, "commands.summonentity.outOfWorld", new Object[0]);
            }
            else
            {
                ...
                if (p_71515_2_.length >= 5)
                {
                    ...
                    try
                    {
                        ...
                        {
                            func_152373_a(p_71515_1_, this, "commands.summonentity.tagError", new Object[] {"Not a valid tag"});
                            return;
                        }
                    ...
                    {
                        func_152373_a(p_71515_1_, this, "commands.summonentity.tagError", new Object[] {nbtexception.getMessage()});
                        return;
                    }
                }
                ...
                if (entity1 == null)
                {
                    func_152373_a(p_71515_1_, this, "commands.summonentity.failed", new Object[0]);
                }
                else
                {
                    ...
                    func_152373_a(p_71515_1_, this, "commands.summonentity.success", new Object[0]);
                }
            }
        }
    }
